...
const mockTransactions = [
  { id: '0x123', type: 'Stake', amount: '100', timestamp: Date.now(), status: 'Pending' },
  { id: '0x456', type: 'Unstake', amount: '50', timestamp: Date.now(), status: 'Completed' },
  { id: '0x789', type: 'Claim', amount: '25', timestamp: Date.now(), status: 'Failed' },
];
  ...
  return (
    <div className="max-w-6xl mx-auto py-12 px-4 mt-16">
      <div className='mb-8 text-white'>
        <h1 className="text-3xl font-bold ">Dashboard {`${address?.slice(0, 6)}...${address?.slice(-4)}`} </h1>
        <p className='text-gray-400 '>View your stake, accumulated rewards and claim your earnings</p>
      </div>

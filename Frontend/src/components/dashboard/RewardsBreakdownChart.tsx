  ...
  return (
    <div className="card bg-[#121212]/80 border border-[#3F3F46] text-white rounded-xl p-6 hover:shadow-lg transition mb-12">
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        {/* Bar Chart */}
        <div>
          <h3 className="text-lg font-medium text-gray-300 mb-4">Value Breakdown</h3>
        ...
        {/* Pie Chart */}
        <div>
          <h3 className="text-lg font-medium text-gray-300 mb-4">Distribution</h3>
          {pieData.length > 0 ? (
            <ResponsiveContainer width="100%" height={280}>
              <PieChart>
                <Pie
            ...
            <div className="flex items-center justify-center h-[280px] text-gray-400">
              <div className="text-center">
                ...
                <p className="text-sm">Start staking to see your distribution</p>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="bg-[#1A1A1A] rounded-lg p-4 border border-[#3F3F46]">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-purple-400">{stakedAmount.toFixed(4)}</p>
            </div>
            <div className="text-purple-400 text-2xl">🔒</div>
          </div>
          <p className="text-xs text-gray-500 mt-1">Currently earning rewards</p>
        </div>
        ...
        <div className="bg-[#1A1A1A] rounded-lg p-4 border border-[#3F3F46]">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-green-400">{claimedAmount.toFixed(4)}</p>
            </div>
        ...
        <div className="bg-[#1A1A1A] rounded-lg p-4 border border-[#3F3F46]">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-yellow-400">{totalFeesCollected.toFixed(4)}</p>
            </div>

    ...
    <div className="card bg-[#121212]/80 border border-[#3F3F46] text-white rounded-xl p-6 hover:shadow-lg transition mb-12">
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full divide-y divide-gray-700">
          <thead>
            <tr>
              {['Transaction', 'Type', 'Amount', 'Date', 'Status'].map((col) => (
              ...
              <tr key={tx.id}>
                ...
                <td className="px-6 py-4">
                  <span className={`px-2 inline-flex text-xs font-semibold rounded-full ${
                    tx.type === 'Stake' ? 'bg-purple-900 text-purple-200' :
                    tx.type === 'Unstake' ? 'bg-red-900 text-red-200' :
                ...
                <td className="px-6 py-4 text-right text-sm font-medium">
                  <a href="#" className="text-primary hover:text-purple-300">View</a>
                </td>
              </tr>
            )) : (
              <tr>
